...
<head>
    ...
    <link href="{{ asset('protected/resources/css/tabler.css?1744816592') }}" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="{{ asset('protected/resources/css/tabler-flags.css?1744816592') }}" rel="stylesheet" />
    <link href="{{ asset('protected/resources/css/tabler-socials.css?1744816592') }}" rel="stylesheet" />
    <link href="{{ asset('protected/resources/css/tabler-payments.css?1744816592') }}" rel="stylesheet" />
    <link href="{{ asset('protected/resources/css/tabler-vendors.css?1744816592') }}" rel="stylesheet" />
    <link href="{{ asset('protected/resources/css/tabler-marketing.css?1744816592') }}" rel="stylesheet" />
    <link href="{{ asset('protected/resources/css/tabler-themes.css?1744816592') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="{{ asset('protected/resources/css/demo.css?1744816592') }}" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
...
<body>
    ...
    <script src="{{ asset('protected/resources/js/tabler-theme.min.js?1744816592') }}"></script>
                ...
                <div class="container-xl">
                    <div class="row text-center align-items-center flex-row-reverse">
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    Copyright &copy; 2025 NexStaff. All rights reserved.
                                </li>
                                <li class="list-inline-item">
    ...
    <script src="{{ asset('protected/resources/js/tabler.min.js?1744816592') }}" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="{{ asset('protected/resources/js/demo.min.js?1744816592') }}" defer></script>
    <!-- END DEMO SCRIPTS -->
</body>
